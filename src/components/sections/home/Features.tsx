...
const DEFAULT_FEATURES = {
  ...
  mainDescription:
    'Streamline your accounting operations with our comprehensive financial management solution designed specifically for small businesses and entrepreneurs.',
  ...
  feature4Description:
    'Handle multiple business entities, subsidiaries, and locations from a single unified dashboard.',
  feature4Badge: 'Multi-Entity',
  feature5Title: 'Advanced Financial Reports',
  feature5Description:
    'Generate P&L statements, balance sheets, and cash flow reports with 40+ customizable financial templates.',
  feature5Badge: 'Reporting',
  feature6Title: 'Automated Workflows',
  feature6Description:
    'Set up recurring invoices, payment reminders, and expense approvals to streamline your financial processes.',
  feature6Badge: 'Automation',
  feature7Title: 'Banking & Payment Integrations',
  feature7Description:
    'Connect seamlessly with 2,500+ banks and payment processors for automatic transaction import and reconciliation.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Accounting Support',
  feature8Description:
    'Access certified accountants and bookkeepers with dedicated support and 99.9% uptime guarantee.',
  feature8Badge: 'Support',
  feature9Title: 'Data Security & Backup',
  feature9Description:
    'Your financial data is bank-level encrypted, backed up daily, and never shared with unauthorized parties.',
