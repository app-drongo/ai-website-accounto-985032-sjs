...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small businesses who trust Accounto for their financial management. Our team is here to help you get started and answer any questions.',
  formTitle: 'Start Your Free Trial',
  formDescription: "Tell us about your business and we'll set up your account within 24 hours.",
  submitButton: 'Get Free Demo',
  contactSectionTitle: 'Talk to Our Experts',
  method1Title: 'Sales Team',
  method1Description: 'Discuss pricing and features',
  method1Contact: 'sales@accounto.com',
  ...
  office1Address: '250 Financial District, Suite 1200',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Austin',
  office2Address: '1500 Business Park Drive, Floor 8',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'Toronto',
  office3Address: '88 Finance Street, Building C',
  ...
  emailPlaceholder: 'sarah@mybusiness.com',
  companyLabel: 'Business Name *',
  companyPlaceholder: 'Johnson Consulting LLC',
