...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'Accounto',
  description:
    'Automated bookkeeping, real-time financial insights, and tax-ready reports. Built specifically for small businesses and entrepreneurs who want to focus on growth, not paperwork.',
  features: [
  ...
  imageAlt: 'Accounto dashboard showing financial analytics',
  statsLabel1: 'Time Saved',
  statsValue1: '15 hrs/month',
  statsLabel2: 'Accuracy Rate',
  statsValue2: '99.8%',
} as const;
