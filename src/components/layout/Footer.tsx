...
const DEFAULT_FOOTER = {
  ...
  contactEmail: 'support@accounto.com',
  ...
  copyrightText: '© 2024 Accounto. All rights reserved.',
  madeWithText: 'by financial experts',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/accounto',
  social2Href: 'https://facebook.com/accounto',
  social3Href: 'https://instagram.com/accounto',
  social4Href: 'https://linkedin.com/company/accounto',
  social5Href: 'https://github.com/accounto',
} as const;
